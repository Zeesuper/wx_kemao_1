package org.Zeesuper.weixin.library.comtroller;

import org.Zeesuper.weixin.library.domain.DebitList;
import org.Zeesuper.weixin.library.service.LibraryService;
...
@Controller
@RequestMapping("/lzc/library/debit")
...
public class DebitController {
	...
	public String debit(@RequestParam("id") String id, WebRequest request) {
		...
		return "redirect:/lzc/library/debit/list";
	}
