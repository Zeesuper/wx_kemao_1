...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/lzc/menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/lzc/menu/js/jquery.js"></script>
<script type="text/javascript" src="/lzc/menu/js/vue.js"></script>
<script type="text/javascript" src="/lzc/menu/js/menu.js"></script>
